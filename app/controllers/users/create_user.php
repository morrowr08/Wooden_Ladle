...
<!-- This is hidden until something goes wrong with account creation -->
	<div class="create_user_error_message">
		...
		<ul>
			...
			<li>Your user name must be between 6 and 20 characters, starting with a letter and no special characters.</li>
...
<!-- user creates account -->
	<div class="create_user">
		...
		<div>
			<label>Username:</label><input type="text" name="user_name" placeholder="username" required><br>
		</div>
		<div>
